import { colour as themeColour } from '../shared/tokens'
...
const useTextContrast = (colour: string) => {
  ...
  const contrastLightText = useContrastRatio(colour, themeColour.text.light)
  const contrastDarkText = useContrastRatio(colour, themeColour.text.dark)
